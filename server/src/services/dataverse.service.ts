...
export class DataverseService {
  ...
  /**
   * Generic: fetch any Dataverse table/entityset
  ...
  /**
   * Generic: patch a row in any Dataverse entitySet by id
   */
  ...
  /**
   * Generic: create a row in any Dataverse entitySet.
  ...
  /**
   * Update an existing task in Dataverse
   */
  async updateTask(
    taskId: string,
